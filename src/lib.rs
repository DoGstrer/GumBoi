...
mod alu_intruction_tests{
    ...
    fn Ox20_with_z_not_set(){
        let instruction_set: [u8;256] = arr_u8!(256,[0x20,0x03,0xFF,0xFF,0xFF]);
        let initial_state = (Registers{..empty_registers},memory!(0x0=>0x20,0x1=>0x03,0x2=>0xFF,0x3=>0xFF,0x4=>0xFF,0x5=>0xFF),0);
        let expected_state = (Registers{pc:5,..empty_registers},memory!(0x0=>0x20,0x1=>0x03,0x2=>0xFF,0x3=>0xFF,0x4=>0xFF,0x5=>0xFF),12);
    ...
    fn Ox28_with_z_set(){
        ...
        let initial_state = (Registers{f:SET_Z,..empty_registers},memory!(0x0=>0x28,0x1=>0x02,0x2=>0xff,0x3=>0xff,0x4=>0xff),0);
        let expected_state = (Registers{pc:4,f:SET_Z,..empty_registers},memory!(0x0=>0x28,0x1=>0x02,0x2=>0xff,0x3=>0xff,0x4=>0xff),12);
    ...
    fn Ox28_with_z_not_set(){
        let instruction_set: [u8;256] = arr_u8!(256,[0x28,0x02,0xff,0xff]);
        let initial_state = (Registers{..empty_registers},memory!(0x0=>0x28,0x1=>0x02,0x2=>0xff,0x3=>0xff,0x4=>0xff),0);
        let expected_state = (Registers{pc:2,..empty_registers},memory!(0x0=>0x28,0x1=>0x02,0x2=>0xff,0x3=>0xff,0x4=>0xff),8);
    ...
    fn Ox18_negative_jump(){
        ...
        let expected_state = (Registers{a:0x01,pc:2,..empty_registers},memory!(0x0=>0xFF,0x1=>0x3C,0x2=>0xFF,0x3=>0x18,0x4=>0xFC,0x5=>0xff,0x6=>0xff),4);
    ...
    fn Ox18_positive_jump(){
        let initial_state = (Registers{a:0x00,pc:3,..empty_registers},memory!(0x0=>0xFF,0x1=>0x3C,0x2=>0xFF,0x3=>0x18,0x4=>0x01,0x5=>0xff,0x6=>0x3c,0x7=>0xff),0);
        let expected_state = (Registers{a:0x01,pc:7,..empty_registers},memory!(0x0=>0xFF,0x1=>0x3C,0x2=>0xFF,0x3=>0x18,0x4=>0x01,0x5=>0xff,0x6=>0x3c,0x7=>0xff),4);
    ...
    fn Ox3C_without_overflow(){
        let initial_state = (registers!(a:0x0E,f:SET_C | SET_H | SET_N | SET_Z),memory!(0x0=>0x3c,0x1=>0xff),0);
